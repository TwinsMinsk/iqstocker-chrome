...
export function BalanceCard() {
  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 relative overflow-hidden group">
      ...
      <h3 className="text-xs font-black tracking-[0.2em] text-white/30 uppercase mb-8">Current Balance</h3>
      <div className="flex items-baseline gap-3">
         <span className="text-6xl font-black text-white tracking-tighter">
           {subscription?.credits_balance?.toLocaleString() || 0}
         </span>
         <span className="text-indigo-400 font-bold text-sm tracking-widest uppercase">Credits</span>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
         <span className="text-xs text-white/20 font-bold uppercase tracking-widest">Status: Ready</span>
         <Link 
