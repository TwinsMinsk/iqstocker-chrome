  ...
  return (
    <div className="bg-[#050505] text-gray-200 min-h-screen flex items-center justify-center px-4">
      <div className="max-w-2xl w-full">
        {/* Background glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[600px] bg-red-600/10 blur-[120px] rounded-full -z-10 pointer-events-none" />
        
        <div className="relative group max-w-xl mx-auto">
          {/* Animated glow border */}
          <div className="absolute -inset-1 bg-gradient-to-r from-red-500 via-rose-600 to-red-500 rounded-[40px] blur-xl opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
          ...
          <div className="relative bg-[#0a0a0c] rounded-[38px] p-8 md:p-12 border border-white/10 shadow-2xl backdrop-blur-xl text-center">
            ...
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              К сожалению, при обработке платежа возникла проблема.<br />
              Пожалуйста, свяжитесь с нашей технической поддержкой для решения вопроса.
            </p>
